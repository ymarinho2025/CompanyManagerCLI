...
def cadastrar_funcionario():
    ...
    horasTrabalhadas = input_float("Digite as horas trabalhadas do funcionário: ")
    salario_base = input_float("Digite o salário base do funcionário: ")
...
def listar_funcionarios():
    ...
    for i in range(len(funcionarios)):
        print(f"Funcionário {i+1}: {funcionarios[i]['nome']}, Cargo: {funcionarios[i]['cargo']} salario base: {funcionarios[i]['salario_base']}, Valor por hora: {funcionarios[i]['valor_hora']}, Horas trabalhadas: {funcionarios[i]['horas_trabalhadas']}")
        print()
